        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                <strong>GPUs</strong> scaled <span>AI.</span> <br />
                <strong>ZPUs</strong> <em className="italic">decentralize</em> it.
              </h1>
            </motion.div>
            ...
            >
              Building the world's first ZPU (Zero-Knowledge Processing Unit). Run nodes, process private workloads, and earn $NZIDIA for powering the decentralized AI economy.
            </motion.p>
          ...
          >
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-6">Built on</p>
              <div className="flex items-center justify-center gap-8">
                <a
                  href="https://github.com/nzidia"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="opacity-60 hover:opacity-100 hover:drop-shadow-[0_0_8px_rgba(132,194,37,0.5)] transition-all duration-300 flex items-center gap-2 group"
                >
