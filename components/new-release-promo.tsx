      ...
      <div className="mx-auto max-w-4xl rounded-[40px] border border-black/5 dark:border-white/20 p-2 shadow-sm">
        <div className="relative mx-auto h-[400px] max-w-4xl overflow-hidden rounded-[38px] border border-black/5 dark:border-white/20 bg-primary p-2 shadow-sm">
          <div
            ...
            style={{
              background: "radial-gradient(ellipse 60% 40% at 50% 50%, rgba(132, 194, 37, 0.15), transparent 70%)",
            }}
          />
          ...
          <div className="relative z-10">
            <div className="mt-8 text-center">
              <h2 className="text-4xl font-bold text-white mb-6">Compute. Privately.</h2>
              <p className="text-white/60 mb-8">The next wave isn't open AI. It's private AI.</p>
              <svg
                width="100"
                height="50"
                viewBox="0 0 100 50"
